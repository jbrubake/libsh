...
Describe 'libsh.sh' # {{{1
    # Describe 'libsh_sanitize' # {{{2
    #     It 'sanitizes input'
    #         When call libsh_sanitize "foobar" ""
    #         The stdout should equal "foobar"
    #     End
    # End
    # Describe 'libsh_is_set' # {{{2
    #     Parameters
    #         TEST_FOO 1  success
    #         TEST_FOO "" failure
    #     End
    ...
    #         eval "$1=$2"
    #         When call libsh_is_set "$1"
    #         The status should be "$3"
    #     End
    # End
    # Describe 'libsh_option_on_off' # {{{2
    #     Parameters
    #         # Value is truthy
    #         1   0     success
    #         y   0     success
    ...
    #         When call libsh_option_on_off "$1" "$2"
    #         The status should be "$3"
    #     End
    # End
    ...
    Describe '_libsh_parse @import' # {{{2
        ...
        End
    End
    Describe '_libsh_parse invalid @keyword' # {{{1
